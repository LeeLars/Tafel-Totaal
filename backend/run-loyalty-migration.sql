-- Run this SQL script manually on Railway to set up the loyalty system
-- This is the same as migration 006_loyalty_system.sql but can be run directly
...
-- SELECT * FROM loyalty_tiers ORDER BY sort_order;
-- SELECT COUNT(*) FROM customer_loyalty;
-- SELECT COUNT(*) FROM point_transactions;
-- SELECT COUNT(*) FROM loyalty_milestones;
